...
//        when(modelMapper.map(any(QueueToken.class), eq(QueueStatusResponseDto.class)))
//                .thenReturn(new QueueStatusResponseDto());
//
//        // when: addToQueue 메서드를 호출
//        QueueStatusResponseDto response = queueService.addToQueue("user1", "flight1");
//
...
//
//        // when: addToQueue 메서드를 호출
//        QueueStatusResponseDto response = queueService.addToQueue("user2", "flight2");
//
...
//        when(modelMapper.map(activeToken, QueueStatusResponseDto.class)).thenReturn(new QueueStatusResponseDto());
//
//        // when: getQueueStatus 호출
//        QueueStatusResponseDto response = queueService.getQueueStatus("user1", "flight1");
//
...
//        when(modelMapper.map(waitingToken, QueueStatusResponseDto.class)).thenReturn(new QueueStatusResponseDto());
//
//        // when: getQueueStatus 호출
//        QueueStatusResponseDto response = queueService.getQueueStatus("user1", "flight1");
//
...
//        when(modelMapper.map(expiredToken, QueueStatusResponseDto.class)).thenReturn(new QueueStatusResponseDto("expired"));
//
//        // when: getQueueStatus 호출
//        QueueStatusResponseDto response = queueService.getQueueStatus("user1", "flight1");
//
